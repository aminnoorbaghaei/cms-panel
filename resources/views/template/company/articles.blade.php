                        ...
                        <div class="tm-blog-list mt-50-reverse sticky-sidebar">
                            ...
                            <div class="blogitem mt-50">
                                <div class="blogitem-image">
                                    <a target="{{$article->target}}" href="{{route("front.single.article",['lang'=>get_segment(1),$article->id] )}}">
                                ...
                                <div class="blogitem-content">
                                    ...
                                    <h5><a target="{{$article->target}}" href="{{route("front.single.article",['lang'=>get_segment(1),$article->id])}}">{{$article->title}} </a></h5>
                                    <p>
                                        {{$article->body}}
                                       </p>
                                    <a target="{{$article->target}}" href="{{route("front.single.article",['lang'=>get_segment(1),$article->id])}}" class="tm-button tm-button-dark">ادامه مطلب<b></b></a>
                                </div>
                            </div>
                            <!--// Blog Item -->
                                ...
                                <ul>
                                    <li>
                                        <a href="blog-details.html" class="widget-recentpost-image">
                                            <img src="/public/template/company/img/pic-2.png"
                                                 alt="blog thumbnail">
                                        </a>
