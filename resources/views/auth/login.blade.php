...
<div class="main-wrapper">
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(/public/admin/img/general/nature-wallpapers-for-desktop-background-full-screen.jpg) no-repeat center center;background-size:cover;">
        <div class="auth-box on-sidebar">
            <form method="POST" action="{{ route('login') }}">
                {{ csrf_field() }}
            <div id="loginform">
                <div class="logo">
                    <span class="db"><img src="/public/template/company/img/pic-6.png" alt="logo"></span>
                    <h5 class="font-medium mb-3">{{$trans['LoginToAdminPanel']}}</h5>
                    <div>
                        @if ($errors->has('email'))
