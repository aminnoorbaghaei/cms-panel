...
{{inject('admin','informations.edit')}}

@section("content")

    <form action="{{route("informations.update",['id'=>$information->id])}}" method="post" enctype="multipart/form-data" >
    ...
    <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">
                    <span>{{$trans['EditInfo']}}  - {{$information->title}} </span>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="  {{$information->title}}" class="form-control" id="date" type="text" name="title">
                        </div>
...
<textarea class="input-block-level" id="summernote" name="body" rows="18">{!! $information->body !!}
					</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="  {{$information->description}}" class="form-control" id="date" type="text" name="description">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="  {{$information->keyword}}" class="form-control" id="date" type="text" name="keyword">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group" data-select2-id="9">
                                ...
                                <input name="status" type="checkbox" {{($information->status=="1") ? "checked" : "" }} data-toggle="toggle">
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    <div class="col-md-4">
        @include("admin.section.changePhoto",['data'=>$information])
    </div>
