...
<div class="row">
        ...
        <div class="card">
            <form  action="{{route("products.store")}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>{{$trans['Excerpt']}}</label>
                        <div class="input-group">

                            <input value="{{old("excerpt")}}" name="excerpt" class="form-control" id="date" type="text">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{old("description")}}" name="description" class="form-control" id="date" type="text">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{old("keyword")}}" name="keyword" class="form-control" id="date" type="text">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{old("price")}}" name="price" class="form-control" id="date" type="text">
                        </div>
    ...
    <div class="col-md-4">
        ...
        <form action="{{route("cat.insert.product")}}" method="POST">
