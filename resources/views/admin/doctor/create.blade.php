    ...
    <div class="row">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="age" type="number" value="{{old('age')}}" name="order" data-bts-min="0" data-bts-max="100" data-bts-init-val="" data-bts-step="1" data-bts-decimal="0" data-bts-step-interval="100" data-bts-force-step-divisibility="round" data-bts-step-interval-delay="500" data-bts-prefix="" data-bts-postfix="" data-bts-prefix-extra-class="" data-bts-postfix-extra-class="" data-bts-booster="true" data-bts-boostat="10" data-bts-max-boosted-step="false" data-bts-mousewheel="true" data-bts-button-down-class="btn btn-info" data-bts-button-up-class="btn btn-info">
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <select  class="form-control select2-single select2-hidden-accessible" id="request-specialty" data-select2-id="select2-1" tabindex="-1" aria-hidden="true" name="langSpe">
                            ...
                            <div class="col-4">
                                <label for="inputEmail3" class="control-label col-form-label">{{$trans['Statistics']}}  </label>
                                <div class="input-group" id="result-specialty">
                            ...
                            <div class="col-4">
                                <label for="inputEmail3" class="control-label col-form-label"> {{$trans['Healths']}} </label>
                                <div class="input-group" id="result-health">
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$trans['Options']}}</h4>
                        <ul class="nav nav-pills mt-4 mb-1">
                            <li class=" nav-item"> <a href="#navpills-1" class="nav-link active" data-toggle="tab" aria-expanded="false">{{$trans['Statistics']}}</a> </li>
                            <li class="nav-item"> <a href="#navpills-2" class="nav-link" data-toggle="tab" aria-expanded="false">{{$trans['Healths']}}</a> </li>
                        ...
                        <div class="tab-content border p-4">
                            <div id="navpills-1" class="tab-pane active">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <form action="{{route("specialty.doctor.insert")}}" method="POST" enctype="multipart/form-data">

                                            {{csrf_field()}}

                                            <div class="card">
                                                <div class="card-header">
                                                    <span>{{$trans['AddNewStatistic']}} </span>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <label>{{$trans['Language']}} </label>
                                                            <select  class="form-control select2-single select2-hidden-accessible" id="request-specialty-url" data-select2-id="select2-1" tabindex="-1" aria-hidden="true" name="langSpe">
                                                        ...
                                                        <div class="col-12">
                                                            <label for="inputEmail3" class="control-label col-form-label">{{$trans['Statistics']}}  </label>
                                                            <div class="input-group" id="result-specialty-url">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <label>{{$trans['Language']}} </label>
                                                            <select  class="form-control select2-single select2-hidden-accessible" id="request-health-url" data-select2-id="select2-1" tabindex="-1" aria-hidden="true" name="langHeal">
                                                        ...
                                                        <div class="col-12">
                                                            <label for="inputEmail3" class="control-label col-form-label"> {{$trans['Healths']}} </label>
                                                            <div class="input-group" id="result-health-url">
