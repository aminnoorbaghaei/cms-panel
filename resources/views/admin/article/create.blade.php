...
<textarea class="input-block-level" id="summernote" name="body" rows="18">
                    ...
                    <div class="card-footer">
                        <div class="action-form">
                            <div class="form-group mb-0 text-left">
                                <button type="submit" class="btn btn-info waves-effect waves-light">{{$trans['Add']}}</button>
        ...
        <div class="col-md-4">
            ...
            <form action="{{route("cat.insert.article")}}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input autocomplete="off" name="name" type="text" class="form-control" value="{{old('name')}}" placeholder="{{$trans['Title']}}" aria-label="Username" aria-describedby="basic-addon1">
