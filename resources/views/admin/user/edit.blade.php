...
@section("content")
    ...
    <div class="row">
        ...
        <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <span>ویرایش کاربر - {{$user->full_name}} </span>
                    ...
                    <div class="card-body">
                        ...
                        <fieldset class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" name="full_name" value="{{$user->full_name}}" id="date" type="text">
                            </div>
        ...
        <div class="col-md-4">
            @include("admin.section.changePhoto",['data'=>$user])
