                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-2">
                            <div class="dataTables_length" id="DataTables_Table_0_length">
                                <label>نمایش</label>
                                <select id="filterCount" data-parent="page" name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" class="custom-select custom-select-sm form-control form-control-sm">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                <a href="{{route('pages.create')}}" title="افزودن">
